...
import { setEventModalStatus, setPartnerModalStatus, setServiceModalStatus, setSubservicesModalStatus, setUserModalStatus, setWellnessTypesModalStatus } from '../../../../../../../redux/features/shared/sharedSlice';
...
console.log('sharedActions.id =========== ',sharedActions.id);
  ...
  return (
    <>
      {(sharedActions.id === "User" || sharedActions.id === "Event" || sharedActions.id === "WellnessTypes"
